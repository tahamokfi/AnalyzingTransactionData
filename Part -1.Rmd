---
title: "Analyzing Transaction data like a data scientist"
subtitle: "Part 1"
author: "Taha Mokfi"
date: "March 24, 2017"
...
<center>![Original dataset](D:/job/Portfolio/Rpubs/transactional datasets/Table1.PNG)</center>

You can either crosstab it based on each Invoice ID like this one:

<center>![Based on Invoice ID](D:/job/Portfolio/Rpubs/transactional datasets/Invtable.PNG)</center>

Or do crosstab on it based on customer Id which would be similar to this one:

<center>![Based on Invoice ID](D:/job/Portfolio/Rpubs/transactional datasets/custable.PNG)</center>
